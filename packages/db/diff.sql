...
-- AlterTable
ALTER TABLE "AccountingSettings" ADD COLUMN     "defaultVatRate" DECIMAL(65,30) DEFAULT 19,
ADD COLUMN     "isVatPayer" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "taxRate" DECIMAL(65,30) NOT NULL DEFAULT 1,
ADD COLUMN     "taxRegime" TEXT NOT NULL DEFAULT 'micro_1',
